...
(
	...
	ID 								NUMBER							PRIMARY KEY,
	LAST_MODIFIED				TIMESTAMP,
	FIRST_NAME					NVARCHAR2(512)			NOT NULL,
	GENDER							NVARCHAR2(64),
...
(
	...
	CONSTRAINT UNIQUE_BIKE_AVAILABILITY_MAP#I UNIQUE (BIKE_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_CITY_BIKE_FEATURES#ID#E UNIQUE (CITY_BIKE_ID,ELEMENT)
);
