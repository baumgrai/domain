...
CREATE INDEX DOM_IDX_CLIENT_REGION_IN_USE#L ON DOM_CLIENT_REGION_IN_USE (LAST_MODIFIED);
...
CREATE INDEX DOM_IDX_DELIVERY_NOTE#LAST_MOD ON DOM_DELIVERY_NOTE (LAST_MODIFIED);
