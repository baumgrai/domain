ALTER TABLE DOM_INVOICE DROP CONSTRAINT FK_INVOICE#ORDER;
...
ALTER TABLE DOM_DELIVERY_NOTE DROP CONSTRAINT FK_DELIVERY_NOTE#ORDER;
...
CREATE TABLE DOM_DELIVERY_NOTE
(
	DOMAIN_CLASS				NVARCHAR(64),
	ID 								BIGINT							PRIMARY KEY,
	LAST_MODIFIED				DATETIME,
...
CREATE INDEX DOM_IDX_DELIVERY_NOTE#LAST_MODIFIED ON DOM_DELIVERY_NOTE (LAST_MODIFIED);
...
CREATE INDEX DOM_IDX_INVOICE#LAST_MODIFIED ON DOM_INVOICE (LAST_MODIFIED);
...
ALTER TABLE DOM_DELIVERY_NOTE ADD CONSTRAINT FK_DELIVERY_NOTE#ORDER FOREIGN KEY (ORDER_ID) REFERENCES DOM_ORDER(ID) ON DELETE CASCADE;
...
ALTER TABLE DOM_INVOICE ADD CONSTRAINT FK_INVOICE#ORDER FOREIGN KEY (ORDER_ID) REFERENCES DOM_ORDER(ID) ON DELETE CASCADE;
