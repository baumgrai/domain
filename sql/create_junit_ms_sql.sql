...
(
	...
	CONSTRAINT UNIQUE_A#I#VALUE UNIQUE (I,INTEGER_VALUE)
);
...
(
	...
	CONSTRAINT UNIQUE_A_STRINGS#ID#ORDER UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_DOUBLE_SET#ID#ELEMENT UNIQUE (A_ID,ELEMENT)
);
...
(
	...
	CONSTRAINT UNIQUE_A_BIG_DECIMAL_MAP#ID#KEY UNIQUE (A_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_A_LIST_OF_LISTS#ID#ORDER UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_LIST_OF_MAPS#ID#ORDER UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_MAP_OF_LISTS#ID#KEY UNIQUE (A_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_A_MAP_OF_MAPS#ID#KEY UNIQUE (A_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_X_IS#ID#ORDER UNIQUE (X_ID,ELEMENT_ORDER)
);
