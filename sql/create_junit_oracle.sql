...
(
	...
	D  								NUMBER							NOT NULL,
	DOUBLE_VALUE				NUMBER,
	C  								NVARCHAR2(1)				NOT NULL,
	CHAR_VALUE					NVARCHAR2(1),
	...
	TIME								TIMESTAMP,
	S  								NVARCHAR2(16),
	STRUCTURE						NVARCHAR2(512),
	PICTURE							BLOB,
	DOM_LONGTEXT				CLOB,
	DOM_FILE						BLOB,
	DOM_TYPE						NVARCHAR2(64)				NOT NULL,
	SEC_SECRET_STRING		NVARCHAR2(512),
	PWD 								NVARCHAR2(512),
	DEPRECATED_FIELD		NVARCHAR2(512),
	O_ID								NUMBER,
...
(
	...
	CONSTRAINT UNIQUE_A_BIG_DECIMAL_MAP#ID#KE UNIQUE (A_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_A_LIST_OF_LISTS#ID#ORDE UNIQUE (A_ID,ELEMENT_ORDER)
);
