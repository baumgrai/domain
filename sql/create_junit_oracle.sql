...
(
	...
	CONSTRAINT UNIQUE_A_STRINGS#A_ID#ELEMENT_ UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_DOUBLE_SET#A_ID#ELEME UNIQUE (A_ID,ELEMENT)
);
...
(
	...
	CONSTRAINT UNIQUE_A_BIG_DECIMAL_MAP#A_ID# UNIQUE (A_ID,ENTRY_KEY)
);
...
(
	...
	CONSTRAINT UNIQUE_A_LIST_OF_LISTS#A_ID#EL UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_LIST_OF_MAPS#A_ID#ELE UNIQUE (A_ID,ELEMENT_ORDER)
);
...
(
	...
	CONSTRAINT UNIQUE_A_MAP_OF_LISTS#A_ID#ENT UNIQUE (A_ID,ENTRY_KEY)
);
