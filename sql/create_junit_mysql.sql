...
ALTER TABLE DOM_A_SEC_STRINGS DROP FOREIGN KEY FK_A_SEC_STRINGS$A;
...
(
	...
	NAME								VARCHAR(1024) CHARACTER SET UTF8MB4,
	C_ID								BIGINT
);
...
(
	...
	BYTES								LONGBLOB,
	PICTURE							LONGBLOB,
	DOM_FILE						VARCHAR(1024) CHARACTER SET UTF8MB4,
	DOM_TYPE						VARCHAR(64) CHARACTER SET UTF8MB4		NOT NULL,
	SEC_SECRET_STRING		VARCHAR(1024) CHARACTER SET UTF8MB4,
	PWD 								VARCHAR(1024) CHARACTER SET UTF8MB4,
	DEPRECATED_FIELD		VARCHAR(1024) CHARACTER SET UTF8MB4,
	O_ID								BIGINT,
...
CREATE TABLE DOM_A_SEC_STRINGS
(
	A_ID								BIGINT							NOT NULL,
	ELEMENT							VARCHAR(1024) CHARACTER SET UTF8MB4,
...
(
	A_ID								BIGINT							NOT NULL,
	ENTRY_KEY						BIGINT,
	ENTRY_VALUE					VARCHAR(1024) CHARACTER SET UTF8MB4,
...
(
	...
	ID 								BIGINT							PRIMARY KEY,
	LAST_MODIFIED				DATETIME,
	S  								VARCHAR(1024) CHARACTER SET UTF8MB4,
	A_ID								BIGINT,
	Y_ID								BIGINT
);
...
ALTER TABLE DOM_A_SEC_STRINGS ADD CONSTRAINT FK_A_SEC_STRINGS$A FOREIGN KEY (A_ID) REFERENCES DOM_A(ID);
