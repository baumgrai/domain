...
- `List`s, `Set`s and `Map`s of these types (`List<String>`) as persistable field types and also as elements of collections or values of maps (`List<Map<LocalDate, Double>>`, `Map<String>, Set<Integer>`)
