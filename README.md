...
- initially create an `SqlDomainController` object, which connects to the persistence database, and call `SqlDomainController#synchronize()` to load persisted objects from database
