...
5) In your code:
   - Initially create a so called domain controller and call `SqlDomainController#synchronize()` to synchronize local object store with persistence database
...
- version control - annotate version information to new, changed and removed classes and fields and let `Java2Sql` tool generate incremental database update scripts 
